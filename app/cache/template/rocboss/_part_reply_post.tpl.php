...
<li class="topic-view reply-bg">
    <?php if ($loginInfo['uid'] > 0) { ?>
        ...
        <form id="reply-add" class="add-post">
            ...
            <fieldset>
                ...
                <input type="text" name="tid" id="tid" value="<?php echo $topicInfo['tid'] ?>" style="display:none;"/>
                <div class="textarea">
        ...
        <script type="text/javascript">
            var editor = new Simditor({
              textarea: $('#subject'),
              defaultImage: '<?php echo $tpl ?>assets/img/default.jpg'
            });
        </script>
        <div class="clear"></div>
        <?php }else{ ?>
    ...
    <?php }else{ ?>
        <span id="login-tip">
            亲，<a href="<?php echo $root ?>login">登录</a>后才能发表回复哦~
        </span>
    <?php } ?>
</li>